#include "../Include/Kerosene Renderer/PostProcessGrey.h"
#include "../Include/Kerosene Renderer/FrameBuffer.h"
#include "../Include/Kerosene Renderer/ShaderUtils.h"
#include <iostream>
...
bool GE::PostProcessGreyscale::init()
{
	...
	ppTexture = Texture::CreateTextureFromGLTextureName(ppTextureName, glm::vec2(width, height));
	...
	std::string v_shader_source = loadShaderSourceCode("../../../Kerosene renderer/Shaders/greyscalePostProcess.vs");
	std::string f_shader_source = loadShaderSourceCode("../../../Kerosene renderer/Shaders/greyscalePostProcess.fs");
...
void GE::PostProcessGreyscale::apply(Texture* tex)
{
	...
	glUniform1i(apply_effectLocation, this->effectEnabled);
